...
while True:
	...
	#pink_img=cv2.inRange(frame,(100,0,0),(255,60,255))
	#orange_img=cv2.inRange(frame,(0,0,150),(255,255,60))
	...
	#pink=cv2.dilate(pink_img, kernal)
	#orange=cv2.dilate(orange_img, kernal)
	...
	#res_pink = cv2.bitwise_and(frame,frame, mask= pink_img)
	#res_orange = cv2.bitwise_and(frame,frame, mask= orange_img)
